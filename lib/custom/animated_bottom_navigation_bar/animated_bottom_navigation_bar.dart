...
import 'package:rxvault/custom/animated_bottom_navigation_bar/src/around_custom_painter.dart';
import 'package:rxvault/custom/animated_bottom_navigation_bar/src/circular_notch_and_corner_clipper.dart';
import 'package:rxvault/custom/animated_bottom_navigation_bar/src/circular_notched_and_cornered_shape.dart';
import 'package:rxvault/custom/animated_bottom_navigation_bar/src/exceptions.dart';
import 'package:rxvault/custom/animated_bottom_navigation_bar/src/gap_item.dart';
import 'package:rxvault/custom/animated_bottom_navigation_bar/src/navigation_bar_item.dart';
import 'package:rxvault/custom/animated_bottom_navigation_bar/src/safe_area_values.dart';
import 'package:rxvault/custom/animated_bottom_navigation_bar/src/visible_animator.dart';

export 'package:rxvault/custom/animated_bottom_navigation_bar/src/safe_area_values.dart';
...
class AnimatedBottomNavigationBarState
  ...
  Widget _buildBody(BuildContext context) {
    bool forDesktop = widget.forDesktop;
    final bottomPadding =
        widget.safeAreaValues.bottom ? 0 : MediaQuery.paddingOf(context).bottom;
    return Container(
      height: forDesktop
          ? null
          : (widget.height ?? kBottomNavigationBarHeight) + bottomPadding,
      width: forDesktop
          ? ((widget.height ?? kBottomNavigationBarHeight) + bottomPadding)
          : null,
